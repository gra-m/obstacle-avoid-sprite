...
import static com.obstacleavoid.assets.RegionNames.BACKGROUND;
import static com.obstacleavoid.assets.RegionNames.OBSTACLE;
import static com.obstacleavoid.assets.RegionNames.PLAYER;
...
public class GameRendererOld implements Disposable
{
    ...
    private final GameControllerOld gameController;
    ...
    public GameRendererOld(SpriteBatch batch, AssetManager assetManager, GameControllerOld gameController)
    {
